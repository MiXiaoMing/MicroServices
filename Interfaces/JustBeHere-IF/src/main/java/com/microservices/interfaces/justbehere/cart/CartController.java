...
public class CartController {
    ...
    public ResponseModel<Cart> updateDeliveryAddress(@RequestHeader("token") String token,
                                                                    @RequestBody CartBody body) {
        ResponseModel<Cart> responseModel = new ResponseModel<>();
    ...
    public ResponseModel<Cart> deleteDeliveryAddress(@RequestHeader("token") String token,
    ...
    public ResponseArrayModel<Cart> getAllDeliveryAddress(@RequestHeader("token") String token) {
